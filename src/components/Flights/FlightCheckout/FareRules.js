...
const FareRules = (props) => {
  return (
    <>
    <div className="popupouterlayer">
      <div className="commonOverlay ">
        <span aria-hidden="true" className="close-icon" onClick={props.onClose}>
          &times;
        </span>
          ...
          <div className="appendBottom15">
            ...
            <div className="tab-content">
              <div
                role="tabpanel"
                aria-hidden="false"
                className="fade rtaFareRules-content tab-pane active show"
              >
                <div>
                    ...
                    <div className="card">
                      <div className="card-header">
                        <div className="makeFlex spaceBetween">
                          <span className="makeFlex perfectCenter">
                            <span className="icon30 bgProperties appendRight10 boldFont"></span>
                            Chandigarh-Hyderabad
                            <span className="fontSize12 lightFont darkText appendLeft5">
                              (via stop 1 - BLR )
                            </span>
                          </span>
                      ...
                      <div className="collapse show">
                        <div className="card-body">
                          <div className="flightDetails darkText fontSize12 appendBottom12">
                            <div className="DateChangeInfo">
                              <div className="flightDetailsInfoLeft">
                                <p className="fontSize14 boldFont blackText">
                                  Time frame
                                </p>
                          ...
                          <p className="darkText fontSize12 appendBottom12 appendLeft10 appendTop10">
                  ...
                  <div className="infoStrip appendTop15 appendBottom15">
                    <b>*Important:</b> The airline fee is indicative. MakeMyTrip
              ...
              <div
                role="tabpanel"
                aria-hidden="true"
                className="fade rtaFareRules-content tab-pane"
              >
                <div>
                  <div className="accordion">
                    <div className="card">
                  ...
                  <div className="infoStrip appendTop15 appendBottom15">
                    <b>*Important:</b> The airline fee is indicative. MakeMyTrip
                    does not guarantee the accuracy of this information. All
                    fees mentioned are per passenger. Date change charges are
                    applicable only on selecting the same airline on a new date.
                    The difference in fares between the old and the new booking
