...
const FlightSearch = () => {
    ...
    const handleSearch = async (event) => {
      ...
      try {
        const response = await axios.get(`localhost:3000/api/flight-booking?originLocationCode=${encodeURIComponent(origin)}&destinationLocationCode=${encodeURIComponent(destination)}&departureDate=${encodeURIComponent(departDate)}&adults=${encodeURIComponent(travellers)}`);
  ...
  <div className="container">
    ...
    <div className="tab-content">
      {/* oneway search */}
      {flight ?(<div id="hotels" className="tab-pane active" onSubmit={handleSearch}>
        <div className="row">
                ...
                <div className="dropdown" id="myDD">
                  ...
                  >
                    ...
                    <span className="text-truncate">
                      {adults+child+infants} Traveller(s), {cabinClass}
                    </span>
                  </button>
                  {toggle && (
                  <div
      ...
      (<div id="Flights" className="tab-pane fade">
        <div className="row">
          <div className="col-sm-12 col-md-12">
            {/* Nav tabs */}
            <ul className="nav nav-tabs border-0 justify_end" role="tablist">
              <li className="nav-item">
                <button
                  className="nav-link active"
                  id="oneway-tab"
  ...
  <section className="promo-ban" id="specialsDeals" style={{ display: "none" }}>
    <div className="container">
