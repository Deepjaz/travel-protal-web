    ...
    return (
        ...
        <>
            <div className="row overflow-hidden py-5">
                <div
                    className="col-12 col-lg-3 align-self-center aos-init aos-animate"
                    data-aos="fade-right"
                >
                    <p className="fw-bold theme-text-accent-two">How it works?</p>
                    <h3 className="h3 fw-bold theme-text-secondary mb-3">
                        Amazing Deals Best Prices
                    </h3>
                    <p className="font-small fw-bold theme-text-accent-one mb-0">
                ...
                <div
                    ...
                    data-aos="fade-left"
                >
                    <div className="text-center theme-box-shadow theme-border-radius process-card">
                        <svg
                        ...
                        >
                            <g id="how-it-work-icon01" transform="translate(-127.859 -231.165)">
                                <g
                                    id="Group_394"
                                    data-name="Group 394"
                                    transform="translate(127.859 231.165)"
                                >
                                    <g
                                        id="Group_380"
                                        data-name="Group 380"
                                        transform="translate(0 6.771)"
                                    >
                                        <path
                                            id="Rectangle_86"
                                    ...
                                    >
                                        <path
                                            ...
                                            transform="translate(-133.874 -231.165)"
                                            fill="#fff"
                                        />
                                    </g>
                                    <g
                                    ...
                                    >
                                        <path
                                            ...
                                            transform="translate(-155.097 -231.165)"
                                            fill="#fff"
                                        />
                                    </g>
                                    <g
                                    ...
                                    >
                                        <path
                                            ...
                                            transform="translate(-165.709 -231.165)"
                                            fill="#fff"
                                        />
                                    </g>
                                </g>
                                <g
                                    id="Group_401"
                                    data-name="Group 401"
                                    transform="translate(138.986 244.862)"
                                >
                                    <g
                                        id="Group_395"
                                        data-name="Group 395"
                                        transform="translate(1.826 59.552)"
                                    >
                                        <path
                                            id="Path_3033"
                                            data-name="Path 3033"
                                            d="M156.923,288.708l-18.807-.612,14.1,9.869Z"
                                            transform="translate(-138.117 -288.096)"
                                            fill="#878787"
                                        />
                                    </g>
                                    <g
                                    ...
                                    >
                                        <path
                                            ...
                                            transform="translate(-153.49 -294.415)"
                                            fill="#878787"
                                        />
                                    </g>
                                    <g
                                    ...
                                    >
                                        <path
                                            ...
                                            transform="translate(-136.671 -244.946)"
                                            fill="#878787"
                                        />
                                    </g>
                                    <g
                                    ...
                                    >
                                        <path
                                            ...
                                            transform="translate(-178.404 -263.43)"
                                            fill="#878787"
                                        />
                                    </g>
                                    <g
                                    ...
                                    >
                                        <path
                                            ...
                                            transform="translate(-149.269 -242.012)"
                                            fill="#002e5b"
                                        />
                                    </g>
                                    <g
                                        id="Group_400"
                                        data-name="Group 400"
                                        transform="translate(19.367 2.076)"
                                    >
                                        <path
                                            id="Path_3038"
                                            data-name="Path 3038"
                                            ...
                                            transform="translate(-150.626 -243.656)"
                                            fill="#002e5b"
                                        />
                                    </g>
                                </g>
                        ...
                        <p className="mb-0 pb-5 theme-text-accent-two">
                        ...
                        >
                            ...
                            <g id="how-it-work-icon02" transform="translate(174.583 -174.366)">
                                <ellipse
                                    ...
                                    rx="40.338"
                                    ry="40.338"
                                    transform="translate(-164.454 181.609)"
                                    fill="#cbcfd1"
                                />
                                <path
                                    id="Path_3039"
                                ...
                                <path
                                    ...
                                    transform="translate(0.133 0.135)"
                                    fill="#767676"
                                />
                                <path
                                    id="Path_3042"
                                ...
                                <path
                                    ...
                                    transform="translate(0.597 0.217)"
                                    fill="#767676"
                                />
                                <path
                                    id="Path_3044"
                                    ...
                                    transform="translate(0.392 0.405)"
                                    fill="#767676"
                                />
                                <path
                                    id="Path_3045"
                                    ...
                                    transform="translate(0.597 0.36)"
                                    fill="#767676"
                                />
                                <path
                                    id="Path_3046"
                                ...
                                <path
                                    ...
                                    transform="translate(0.246 0.174)"
                                    fill="#767676"
                                />
                                <path
                                    id="Path_3050"
                                    ...
                                    transform="translate(0.265 0.217)"
                                    fill="#767676"
                                />
                                <path
                                    id="Path_3051"
                                    ...
                                    transform="translate(0.277 0.211)"
                                    fill="#767676"
                                />
                                <path
                                    id="Path_3052"
                                ...
                                <path
                                    ...
                                    transform="translate(0.122 0.12)"
                                    fill="#767676"
                                />
                                <path
                                    id="Path_3055"
                                ...
                                <path
                                    ...
                                    transform="translate(4.93 0.252)"
                                    fill="none"
                                    stroke="#c8c8c8"
                                    strokeMiterlimit={10}
                                    strokeWidth={3}
                                ...
                                <g
                                    id="Group_410"
                                    data-name="Group 410"
                                    transform="translate(-174.583 237.833)"
                                >
                                    <g
                                        id="Group_404"
                                        data-name="Group 404"
                                        transform="translate(29.594)"
                                    >
                                        <g id="Group_403" data-name="Group 403">
                                            <path
                                                ...
                                                transform="translate(144.989 -237.234)"
                                                fill="#fff"
                                            />
                                        </g>
                                    </g>
                                    <path
                                        ...
                                        transform="translate(174.583 -237.234)"
                                        fill="#fff"
                                    />
                                    <path
                                        id="Path_3061"
                                    ...
                                    <g
                                        id="Group_405"
                                        data-name="Group 405"
                                        transform="translate(2.729 7.825)"
                                    >
                                        <path
                                            id="Path_3063"
                                            data-name="Path 3063"
                                            ...
                                            transform="translate(171.854 -245.059)"
                                            fill="#fff"
                                        />
                                    </g>
                                    <g
                                        id="Group_406"
                                        data-name="Group 406"
                                        transform="translate(48.738 11.55)"
                                    >
                                        <path
                                            id="Path_3064"
                                            data-name="Path 3064"
                                            ...
                                            transform="translate(125.845 -248.784)"
                                            fill="#002e5b"
                                        />
                                        <path
                                            id="Path_3065"
                                    ...
                                    >
                                        <path
                                            ...
                                            transform="translate(119.895 -250.993)"
                                            fill="#002e5b"
                                        />
                                        <path
                                            id="Path_3071"
                                    ...
                                    <g
                                        id="Group_409"
                                        data-name="Group 409"
                                        transform="translate(10.71 15.072)"
                                    >
                                        <g id="Group_408" data-name="Group 408">
                                            <path
                                                ...
                                                transform="translate(163.873 -252.306)"
                                                fill="#fff"
                                            />
                                            <path
                                                id="Path_3077"
                                ...
                                <path
                                    ...
                                    transform="translate(0.344 0.12)"
                                    fill="#878787"
                                />
                                <path
                                    id="Path_3097"
                                    data-name="Path 3097"
                                    d="M-125.924,191.7l-.013,0h0Z"
                                ...
                                <path
                                    id="Path_3099"
                                    data-name="Path 3099"
                                    d="M-125.935,191.706l.011,0-.013,0Z"
                                    transform="translate(0.292)"
                                    fill="#ecaa41"
                                />
                                <path
                                ...
                                <path
                                    ...
                                    transform="translate(0.597 0.133)"
                                    fill="#002e5b"
                                />
                                <g
                                    id="Group_412"
                                    data-name="Group 412"
                                    transform="translate(-106.876 181.197)"
                                >
                                    <path
                                        id="Path_3103"
                                        data-name="Path 3103"
                                        ...
                                        transform="translate(107.473 -181.197)"
                                        fill="#878787"
                                    />
                                    <path
                                        id="Path_3104"
                        ...
                        >
                            <g id="how-it-work-icon03" transform="translate(-177.403 -192.402)">
                                <g
                                    id="Group_414"
                                    data-name="Group 414"
                                    transform="translate(184.197 228.304)"
                                >
                                    <rect
                                        id="Rectangle_91"
                                    ...
                                    <rect
                                        ...
                                        width="1.935"
                                        height="1.935"
                                        transform="translate(54.59 1.727)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_93"
                                        ...
                                        width="1.935"
                                        height="1.935"
                                        transform="translate(58.334 1.727)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_94"
                                        ...
                                        width="1.935"
                                        height="1.935"
                                        transform="translate(61.964 1.727)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_95"
                                        ...
                                        width="69.124"
                                        height="0.789"
                                        transform="translate(0.81 0.473)"
                                        fill="#c1c1c1"
                                    />
                                    <rect
                                        id="Rectangle_96"
                                        ...
                                        width="69.124"
                                        height="42.852"
                                        transform="translate(0.81 5.024)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_97"
                                        ...
                                        width={65}
                                        height="35.768"
                                        transform="translate(2.809 8.713)"
                                        fill="#a0a0a0"
                                    />
                                    <path
                                        id="Path_3107"
                                        ...
                                        transform="translate(-184.197 -224.954)"
                                        fill="#fff"
                                    />
                                    <path
                                        id="Path_3108"
                                    ...
                                    <rect
                                        ...
                                        width="11.097"
                                        height="1.146"
                                        transform="translate(11.714 10.826)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_99"
                                        ...
                                        width="11.097"
                                        height="1.146"
                                        transform="translate(31.148 10.826)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_100"
                                        ...
                                        width="20.455"
                                        height="1.146"
                                        transform="translate(12.592 14.146)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_101"
                                        ...
                                        width="20.455"
                                        height="1.146"
                                        transform="translate(34.15 14.146)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_102"
                                        ...
                                        width="19.641"
                                        height="1.146"
                                        transform="translate(9.809 20.785)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_103"
                                        ...
                                        width="31.17"
                                        height="1.146"
                                        transform="translate(13.208 17.465)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_104"
                                        ...
                                        width="20.455"
                                        height="1.146"
                                        transform="translate(12.592 24.105)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_105"
                                        ...
                                        width="5.035"
                                        height="1.146"
                                        transform="translate(24.179 10.826)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_106"
                                        ...
                                        width="5.035"
                                        height="1.146"
                                        transform="translate(43.986 10.826)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_107"
                                        ...
                                        width="5.035"
                                        height="1.146"
                                        transform="translate(31.148 20.785)"
                                        fill="#fff"
                                    />
                                    <path
                                        id="Path_3112"
                                    ...
                                    <rect
                                        ...
                                        width="11.097"
                                        height="1.146"
                                        transform="translate(11.714 27.46)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_109"
                                        ...
                                        width="11.097"
                                        height="1.146"
                                        transform="translate(31.148 27.46)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_110"
                                        ...
                                        width="5.035"
                                        height="1.146"
                                        transform="translate(24.179 27.46)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_111"
                                        ...
                                        width="5.035"
                                        height="1.146"
                                        transform="translate(43.986 27.46)"
                                        fill="#fff"
                                    />
                                    <path
                                        id="Path_3113"
                                    ...
                                    <rect
                                        ...
                                        width="11.097"
                                        height="1.146"
                                        transform="translate(11.714 31.269)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_113"
                                        ...
                                        width="11.097"
                                        height="1.146"
                                        transform="translate(31.148 31.269)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_114"
                                        ...
                                        width="20.455"
                                        height="1.146"
                                        transform="translate(12.592 34.589)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_115"
                                        ...
                                        width="20.455"
                                        height="1.146"
                                        transform="translate(34.15 34.589)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_116"
                                        ...
                                        width="19.641"
                                        height="1.146"
                                        transform="translate(9.809 41.228)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_117"
                                        ...
                                        width="31.17"
                                        height="1.146"
                                        transform="translate(13.208 37.909)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_118"
                                        ...
                                        width="5.035"
                                        height="1.146"
                                        transform="translate(24.179 31.269)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_119"
                                        ...
                                        width="5.035"
                                        height="1.146"
                                        transform="translate(55.866 34.589)"
                                        fill="#fff"
                                    />
                                    <rect
                                        id="Rectangle_120"
                                        ...
                                        width="5.035"
                                        height="1.146"
                                        transform="translate(31.148 41.228)"
                                        fill="#fff"
                                    />
                                </g>
                                <g
                                    id="Group_415"
                                    data-name="Group 415"
                                    transform="translate(177.403 192.402)"
                                >
                                    <path
                                        id="Path_3117"
                                        data-name="Path 3117"
                                ...
                                <g
                                    id="Group_417"
                                    data-name="Group 417"
                                    transform="translate(255.986 212.656)"
                                >
                                    <g id="Group_416" data-name="Group 416">
                                        <path
                                            ...
                                            transform="translate(-251.18 -211.045)"
                                            fill="#8a8a8a"
                                        />
                                    </g>
                                    <path
                                ...
                                <path
                                    ...
                                    transform="translate(3.188)"
                                    fill="#767676"
                                />
                                <g
                                    id="Group_418"
                                    data-name="Group 418"
                                    transform="translate(222.149 259.562)"
                                >
                                    <rect
                                        id="Rectangle_121"
                                    ...
                                    <rect
                                        ...
                                        width="47.614"
                                        height="0.583"
                                        transform="translate(0.476 0.434)"
                                        fill="#c1c1c1"
                                    />
                                    <rect
                                        id="Rectangle_123"
                                        ...
                                        width="47.618"
                                        height="30.107"
                                        transform="translate(0.476 2.952)"
                                        fill="#fff"
                                    />
                                    <path
                                        id="Path_3128"
                                        ...
                                        transform="translate(-217.342 -254.716)"
                                        fill="#76a9ab"
                                    />
                                    <path
                                        id="Path_3129"
                                    ...
                                    <rect
                                        ...
                                        width="21.82"
                                        height="1.531"
                                        transform="translate(9.554 8.078)"
                                        fill="#a0a0a0"
                                    />
                                    <rect
                                        id="Rectangle_125"
                                        ...
                                        width="34.318"
                                        height="1.531"
                                        transform="translate(10.726 12.512)"
                                        fill="#a0a0a0"
                                    />
                                    <rect
                                        id="Rectangle_126"
                                        ...
                                        width="33.231"
                                        height="1.531"
                                        transform="translate(7.01 21.378)"
                                        fill="#a0a0a0"
                                    />
                                    <rect
                                        id="Rectangle_127"
                                        ...
                                        width="33.495"
                                        height="1.531"
                                        transform="translate(11.549 16.945)"
                                        fill="#a0a0a0"
                                    />
                                    <rect
                                        id="Rectangle_128"
                                        ...
                                        width="34.318"
                                        height="1.531"
                                        transform="translate(10.726 25.812)"
                                        fill="#a0a0a0"
                                    />
                                    <rect
                                        id="Rectangle_129"
                                        ...
                                        width="6.724"
                                        height="1.531"
                                        transform="translate(33.2 8.078)"
                                        fill="#a0a0a0"
                                    />
                                </g>
                            </g>
